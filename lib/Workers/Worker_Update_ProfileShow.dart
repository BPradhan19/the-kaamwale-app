...
import 'Worker_ScreenShow.dart';
import '../Models/user_data_models.dart';

class Worker_Update_ProfileShow extends StatefulWidget {
  const Worker_Update_ProfileShow({super.key});

  @override
  State<Worker_Update_ProfileShow> createState() =>
      _Worker_Update_ProfileShowState();
}

class _Worker_Update_ProfileShowState extends State<Worker_Update_ProfileShow> {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            title: const Text('*PROFILE UPDATED SUCCESSFULLY*',textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),//
