...
class Result_ScreenShow extends StatefulWidget {
  final List<UserData> electricians;

  const Result_ScreenShow({Key? key, required this.electricians})
      : super(key: key);

  @override
  State<Result_ScreenShow> createState() => _Result_ScreenShowState();
}

class _Result_ScreenShowState extends State<Result_ScreenShow> {
              ...
              PopScope(
                ...
                onPopInvoked: (bool didPop) async {
                  ...
                  child: const AutoSizeText(
                    "*Search Electrician with Place and Pincode here*",
                    maxLines: 1,
                    style: TextStyle(
                        fontSize: 15,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Container(
                                    ...
                                    child: CircleAvatar(
                                      radius: 50,
                                      backgroundImage: NetworkImage(widget.electricians[index].url), //
                                    ),
                                  ),
                                  const SizedBox(
                                    width: 5,
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              AutoSizeText(
                                                widget.electricians[index].workExp,
                                                maxLines: 1,
                                          ...
                                          AutoSizeText(
                                            widget.electricians[index].place,
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.center,
                                            style: const TextStyle(
                                          ...
                                          AutoSizeText(
                                            widget.electricians[index].city,
                                            textAlign: TextAlign.center,
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                                            style: const TextStyle(
                                          ...
                                          AutoSizeText(
                                            widget.electricians[index].state,
                                            textAlign: TextAlign.center,
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                                            style: const TextStyle(
                                  ...
                                  Container(
                                    ...
                                    child: Material(
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          final String mobileNo = widget.electricians[index].mobileNo;
                              ...
                              AutoSizeText(
                                widget.electricians[index].fullName,
                                overflow: TextOverflow.ellipsis,
                                maxLines: 1,
                                style: const TextStyle(
                                  fontSize: 16,
