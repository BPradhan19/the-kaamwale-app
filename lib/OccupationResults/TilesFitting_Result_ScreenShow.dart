...
class TilesFitting_Result_ScreenShow extends StatefulWidget {
  final List<UserData> tiles_fitting;

  const TilesFitting_Result_ScreenShow({Key? key, required this.tiles_fitting})
      : super(key: key);
            ...
            children: [
              ...
              PopScope(
                ...
                child: const AutoSizeText(
                  "*Search TilesFitting Person with Place and Pincode here*",
                  maxLines: 1,
                  style: TextStyle(
                      fontSize: 15,
