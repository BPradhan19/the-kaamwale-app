...
class Welder_Result_ScreenShow extends StatefulWidget {
  final List<UserData> welder;

  const Welder_Result_ScreenShow({Key? key, required this.welder})
      : super(key: key);

  @override
  State<Welder_Result_ScreenShow> createState() => _Welder_Result_ScreenShowState();
}

class _Welder_Result_ScreenShowState extends State<Welder_Result_ScreenShow> {
            ...
            children: [
              ...
              PopScope(
                ...
                child: const AutoSizeText(
                  "*Search Welder with Place and Pincode here*",
                  maxLines: 1,
                  style: TextStyle(
                      fontSize: 15,
              ...
              Flexible(
                child: ListView.builder(
                  itemCount: widget.welder.length,
                                  ...
                                  children: [
                                    MediaQuery(
                                      ...
                                      child: Container(
                                        ...
                                        child: CircleAvatar(
                                          radius: 50,
                                          backgroundImage: NetworkImage(widget.welder[index].url), //
                                        ),
                                      ),
                                    ),
                                    const SizedBox(
                                    ...
                                    MediaQuery(
                                      ...
                                      child: Container(
                                        ...
                                        child: Material(
                                          ...
                                          child: InkWell(
                                            onTap: () async {
                                              final String mobileNo = widget.welder[index].mobileNo;
