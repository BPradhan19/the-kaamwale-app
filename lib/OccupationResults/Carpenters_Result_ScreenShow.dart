...
class Carpenters_Result_ScreenShow extends StatefulWidget {
  final List<UserData> carpenters;

  const Carpenters_Result_ScreenShow({Key? key, required this.carpenters})
      : super(key: key);

  @override
  State<Carpenters_Result_ScreenShow> createState() => _Carpenters_Result_ScreenShowState();
}

class _Carpenters_Result_ScreenShowState extends State<Carpenters_Result_ScreenShow> {
            ...
            children: [
              ...
              PopScope(
                ...
                child: const AutoSizeText(
                  "*Search Carpenter with Place and Pincode here*",
                  maxLines: 1,
                  style: TextStyle(
                      fontSize: 15,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  AutoSizeText(
                                                    widget.carpenters[index].workExp,
                                                    maxLines: 1,
                                    ...
                                    MediaQuery(
                                      ...
                                      child: Container(
                                        ...
                                        child: Material(
                                          ...
                                          child: InkWell(
                                            onTap: () async {
                                              final String mobileNo = widget.carpenters[index].mobileNo;
                                ...
                                AutoSizeText(
                                  widget.carpenters[index].fullName,
                                  overflow: TextOverflow.ellipsis,
                                  maxLines: 1,
                                  style: const TextStyle(
                                    fontSize: 16,
