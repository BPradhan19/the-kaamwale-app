...
class GlassWorker_Result_ScreenShow extends StatefulWidget {
  final List<UserData> glass_worker;

  const GlassWorker_Result_ScreenShow({Key? key, required this.glass_worker})
      : super(key: key);

  @override
  State<GlassWorker_Result_ScreenShow> createState() => _GlassWorker_Result_ScreenShowState();
}



class _GlassWorker_Result_ScreenShowState extends State<GlassWorker_Result_ScreenShow> {
            ...
            children: [
              ...
              PopScope(
                ...
                child: const AutoSizeText(
                  "*Search Glass Worker with Place and Pincode here*",
                  maxLines: 1,
                  style: TextStyle(
                      fontSize: 15,
              ...
              Flexible(
                child: ListView.builder(
                  itemCount: widget.glass_worker.length,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  AutoSizeText(
                                                    widget.glass_worker[index].workExp,
                                                    maxLines: 1,
                                              ...
                                              AutoSizeText(
                                                widget.glass_worker[index].place,
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                                textAlign: TextAlign.center,
                                                style: const TextStyle(
                                              ...
                                              AutoSizeText(
                                                widget.glass_worker[index].city,
                                                textAlign: TextAlign.center,
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                                style: const TextStyle(
                                              ...
                                              AutoSizeText(
                                                widget.glass_worker[index].state,
                                                textAlign: TextAlign.center,
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                                style: const TextStyle(
                                    ...
                                    MediaQuery(
                                      ...
                                      child: Container(
                                        ...
                                        child: Material(
                                          ...
                                          child: InkWell(
                                            onTap: () async {
                                              final String mobileNo = widget.glass_worker[index].mobileNo;
                                ...
                                AutoSizeText(
                                  widget.glass_worker[index].fullName,
                                  overflow: TextOverflow.ellipsis,
                                  maxLines: 1,
                                  style: const TextStyle(
                                    fontSize: 16,
