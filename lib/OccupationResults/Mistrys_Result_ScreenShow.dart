...
class Mistrys_Result_ScreenShow extends StatefulWidget {
  final List<UserData> mistrys;

  const Mistrys_Result_ScreenShow({Key? key, required this.mistrys})
      : super(key: key);

  @override
  State<Mistrys_Result_ScreenShow> createState() => _Mistrys_Result_ScreenShowState();
}

class _Mistrys_Result_ScreenShowState extends State<Mistrys_Result_ScreenShow> {
            ...
            children: [
              ...
              PopScope(
                ...
                child: const AutoSizeText(
                  "*Search Mistry with Place and Pincode here*",
                  maxLines: 1,
                  style: TextStyle(
                      fontSize: 15,
              ...
              Flexible(
                child: ListView.builder(
                  itemCount: widget.mistrys.length,
