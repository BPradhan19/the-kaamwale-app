...
class Plumbers_Result_ScreenShow extends StatefulWidget {
  final List<UserData> plumbers;

  const Plumbers_Result_ScreenShow({Key? key, required this.plumbers})
      : super(key: key);

  @override
  State<Plumbers_Result_ScreenShow> createState() => _Plumbers_Result_ScreenShowState();
}

class _Plumbers_Result_ScreenShowState extends State<Plumbers_Result_ScreenShow> {
            ...
            children: [
              ...
              PopScope(
                ...
                child: const AutoSizeText(
                  "*Search Plumber with Place and Pincode here*",
                  maxLines: 1,
                  style: TextStyle(
                      fontSize: 15,
              ...
              Flexible(
                child: ListView.builder(
                  itemCount: widget.plumbers.length,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Material(
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          final String mobileNo = widget.plumbers[index].mobileNo;
                              ...
                              AutoSizeText(
                                widget.plumbers[index].fullName,
                                overflow: TextOverflow.ellipsis,
                                maxLines: 1,
                                style: const TextStyle(
                                  fontSize: 16,
