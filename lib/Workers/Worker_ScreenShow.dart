...
import 'Worker_Profile_Exists.dart';
...
class Worker_ScreenShow extends StatefulWidget {
  const Worker_ScreenShow({super.key});

  @override
  State<Worker_ScreenShow> createState() => _Worker_ScreenShowState();
}

class _Worker_ScreenShowState extends State<Worker_ScreenShow> {
  int _selected = 0;
  ...
  Future checkUser() async {
    ...
    if (querySnapshot.docs.isNotEmpty) {
      ...
      Get.off(() => const Worker_Profile_Exists());
    } else {
      // If user data doesn't exist, open profile page
      Get.off(() => const Workers_ProfileShow());
    }
  }
