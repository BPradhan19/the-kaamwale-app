...
class Rejas_Result_ScreenShow extends StatefulWidget {
  final List<UserData> rejas;

  const Rejas_Result_ScreenShow({Key? key, required this.rejas})
      : super(key: key);

  @override
  State<Rejas_Result_ScreenShow> createState() => _Rejas_Result_ScreenShowState();
}

class _Rejas_Result_ScreenShowState extends State<Rejas_Result_ScreenShow> {
            ...
            children: [
              ...
              PopScope(
                ...
                child: const AutoSizeText(
                  "*Search Reja with Place and Pincode here*",
                  maxLines: 1,
                  style: TextStyle(
                      fontSize: 15,
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Material(
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          final String mobileNo = widget.rejas[index].mobileNo;
