...
class AluminiumWorker_Result_ScreenShow extends StatefulWidget {
  final List<UserData> aluminium_worker;

  const AluminiumWorker_Result_ScreenShow({Key? key, required this.aluminium_worker})
      : super(key: key);

  @override
  State<AluminiumWorker_Result_ScreenShow> createState() => _AluminiumWorker_Result_ScreenShow();
}

class _AluminiumWorker_Result_ScreenShow extends State<AluminiumWorker_Result_ScreenShow> {
            ...
            IconButton(
              onPressed: () {
                setState(() {
                  ...
                  widget.aluminium_worker.sort((a, b) {
                    if (_isAscending) {
            ...
            children: [
              ...
              PopScope(
                ...
                child: const AutoSizeText(
                  "*Search Aluminium Worker with Place and Pincode here*",
                  maxLines: 1,
                  style: TextStyle(
                      fontSize: 15,
              ...
              Flexible(
                child: ListView.builder(
                  itemCount: widget.aluminium_worker.length,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    MediaQuery(
                                      ...
                                      child: Container(
                                        ...
                                        child: CircleAvatar(
                                          radius: 50,
                                          backgroundImage: NetworkImage(widget.aluminium_worker[index].url), //
                                        ),
                                      ),
                                    ),
                                    const SizedBox(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  AutoSizeText(
                                                    widget.aluminium_worker[index].workExp,
                                                    maxLines: 1,
                                              ...
                                              AutoSizeText(
                                                widget.aluminium_worker[index].place,
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                                textAlign: TextAlign.center,
                                                style: const TextStyle(
                                              ...
                                              AutoSizeText(
                                                widget.aluminium_worker[index].city,
                                                textAlign: TextAlign.center,
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                                style: const TextStyle(
                                              ...
                                              AutoSizeText(
                                                widget.aluminium_worker[index].state,
                                                textAlign: TextAlign.center,
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                                style: const TextStyle(
                                              ...
                                              AutoSizeText(
                                                widget.aluminium_worker[index].pin,
                                                textAlign: TextAlign.center,
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                                style: const TextStyle(
                                    ...
                                    MediaQuery(
                                      ...
                                      child: Container(
                                        ...
                                        child: Material(
                                          ...
                                          child: InkWell(
                                            onTap: () async {
                                              final String mobileNo = widget.aluminium_worker[index].mobileNo;
                                ...
                                AutoSizeText(
                                  widget.aluminium_worker[index].fullName,
                                  overflow: TextOverflow.ellipsis,
                                  maxLines: 1,
                                  style: const TextStyle(
                                    fontSize: 16,
