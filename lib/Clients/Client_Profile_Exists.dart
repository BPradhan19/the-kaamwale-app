...
import 'Client_Update_ProfileShow.dart';

class Client_Profile_Exists extends StatefulWidget {
  const Client_Profile_Exists({super.key});

  @override
  State<Client_Profile_Exists> createState() => _Client_Profile_ExistsState();
}
                        ...
                        children: [
                          Container(
                            ...
                            decoration: const BoxDecoration(
                              image: DecorationImage(image: AssetImage('assets/images/wallpaperc.jpg'),fit: BoxFit.cover),
                                      ...
                                      ElevatedButton.icon(
                                        onPressed: () {
                                          Navigator.pushReplacement(
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) =>
                                                  const Client_Update_ProfileShow(),
                                            ),
                                          );
                                        },
